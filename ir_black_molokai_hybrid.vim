...
if &t_Co > 255
   ...
   hi Conditional     ctermfg=167               cterm=bold
   ...
   hi Directory       ctermfg=48               cterm=bold
...
" " General colors
hi Normal           guifg=#f6f3e8     guibg=black       gui=NONE      ctermfg=NONE        cterm=NONE
...
if version >= 700 " Vim 7.x specific colors
  hi CursorLine     guifg=NONE        guibg=#121212     gui=NONE      ctermfg=white        cterm=BOLD
